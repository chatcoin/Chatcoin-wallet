...
#ifndef H_CHATCOIN_SCRIPT
#define H_CHATCOIN_SCRIPT
 ...
 *  A CTxDestination is the internal data type encoded in a CChatcoinAddress
 */
...
public:
    ...
    // Pre-version-0.6, Chatcoin always counted CHECKMULTISIGs
