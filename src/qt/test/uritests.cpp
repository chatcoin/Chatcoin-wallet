...
void URITests::uriTests()
{
    ...
    QVERIFY(!GUIUtil::parseChatcoinURI(uri, &rv));
    ...
    QVERIFY(GUIUtil::parseChatcoinURI("talkcoin://TityLcNJr19fC3GREkNbyi5YFpN26iLjEZ?message=Wikipedia Example Address", &rv));
    QVERIFY(rv.address == QString("TityLcNJr19fC3GREkNbyi5YFpN26iLjEZ"));
    QVERIFY(rv.label == QString());
